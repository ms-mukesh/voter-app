...
const {insertBulkDataInDb,getAddressID,addAllAdress, insertBulkVoterList, getVoterList } = require("./handler/voterData")
...
// getVoterList(1,10,'').then((res)=>{console.log(res)})
